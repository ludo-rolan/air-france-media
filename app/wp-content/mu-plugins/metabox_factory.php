...
class MetaBox_Factory
{
    ...
    function create_meta_box()
    {
        add_meta_box(
            $this->meta_box['id'], // $id
            __($this->meta_box['title'],  AFMM_TERMS), // $title
...
?>
        <p>
            <label for="<?php echo $this->meta_id; ?>" style="width:100%"><?php _e($this->box_label,  AFMM_TERMS); ?></label>
            <br />
    ...
    ?>
        <p>
            ...
            wp_editor($this->box_value, $this->meta_id, array(
                'wpautop' => isset($this->args['wpautop']) ? $this->args['wpautop'] : true,
                'media_buttons' => false,
    ...
    ?>
        <p>
            <label for="<?php echo $this->meta_id; ?>" style="width:100%">
                <?php _e($this->box_label,  AFMM_TERMS); ?></label>
            <br />
    ...
    ?>
        <div>
            ...
            <div class="mx-image-uploader">
                ...
                <button class="mx_upload_image button button-primary" <?php echo $image_url !== '' ? 'style="display: none;"' : ''; ?>><?php _e("Choisir une Image", AFMM_TERMS); ?></button>

                <!-- remove image -->
                <a href="#" class="mx_upload_image_remove button" style="color: #b32d2e; font-weight: 600; margin: 20px 0px;  <?php echo $image_url == '' ? 'display: none;' : ''; ?>"><?php _e("Supprimer L'image", AFMM_TERMS); ?></a>
...
class Gallery_MetaBox_Type extends MetaBox_Type
{
    ...
    ?>
        <div id="gallery">
            ...
            <input id="edit-gallery" class="button upload_gallery_button" type="button" value="<?php esc_html_e('Ajout/Modification Gallery', AFMM_TERMS) ?>" />
            <input id="clear-gallery" class="button upload_gallery_button" type="button" value="<?php esc_html_e('Vider', AFMM_TERMS) ?>" />
        ...
        if(!empty($this->args) && !empty($this->args['options'])) {
            foreach($this->args['options'] as $val){ 
                ...
                ?>
                    ...
                    <label for="<?php echo $this->meta_id; ?>" style="width:100%"><?php _e( $val,  AFMM_TERMS ); ?></label>
